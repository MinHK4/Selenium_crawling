...
with requests.Session() as s:
    ...
    # Python3에서 두 dict를 합치는 방법은 {**dict1, **dict2} 으로 dict들을 unpacking하는 것입니다.
    ...
    title = soup.select(' #div_content > div.board_head > div > h2 > a')
    contents = soup.select('#div_content > div.post_view > div.post_content > article > div > h2:nth-child(11)')
...
#div_content > div.post_view > div.post_content > article > div > p:nth-child(14)
